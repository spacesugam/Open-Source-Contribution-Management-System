...
public class AddContributers extends JFrame implements ActionListener{
    
    Random ran = new Random();
    int number = ran.nextInt(999);
    
    JTextField  tpname,tpdesc;
    JDateChooser dcdob;
    JComboBox tplead;
    JLabel prId;
    JButton add, back;
    ...
    AddContributers() {
        ...
        JLabel heading = new JLabel("Add Contributers Detail");
       ...
       // add(tpname);
        ...
        JLabel labelsalary = new JLabel("Contributer Name");
        ...
        JLabel labeladdress = new JLabel("Reputation");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            String crep = (String) tplead.getSelectedItem();
           ...
           // String empId = lblempId.getText();
            ...
            try {
                Conn conn = new Conn();
                String query = "insert into contributers values('"+cid+"', '"+prid+"', '"+cname+"', '"+crep+"', '"+cdob+"')";
